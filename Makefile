...
LDFLAGS := -X github.com/andrew-codes/no-mistakes/internal/buildinfo.Version=$(VERSION) \
           -X github.com/andrew-codes/no-mistakes/internal/buildinfo.Commit=$(COMMIT) \
           -X github.com/andrew-codes/no-mistakes/internal/buildinfo.Date=$(DATE) \
           -X github.com/andrew-codes/no-mistakes/internal/buildinfo.TelemetryHost=$(UMAMI_HOST) \
           -X github.com/andrew-codes/no-mistakes/internal/buildinfo.TelemetryWebsiteID=$(UMAMI_WEBSITE_ID)
